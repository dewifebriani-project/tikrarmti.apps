...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabaseAdmin
      ...
      .select(`
        *,
        user:users!daftar_ulang_submissions_user_id_fkey(id, full_name, email, whatsapp, phone),
        ...
        partner_user:users!daftar_ulang_submissions_partner_user_id_fkey(id, full_name, email, whatsapp, phone)
      `)
