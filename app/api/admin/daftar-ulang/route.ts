...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabaseAdmin
      ...
      .select(`
        *,
        user:users!daftar_ulang_submissions_user_id_fkey(id, full_name, email, wa_phone),
        ...
        partner_user:users!daftar_ulang_submissions_partner_user_id_fkey(id, full_name, email, wa_phone)
      `)
