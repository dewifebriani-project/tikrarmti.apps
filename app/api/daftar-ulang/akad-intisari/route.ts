...
function buildAkadIntisari(registration: any): {
  ...
  content.push('')
  content.push('POIN-POIN AKAD')
  content.push('')
  content.push('')
  content.push('1. Saya berjanji akan selalu memperbaiki niat menghafal karena Allah Ta\'ala.')
  content.push('')
  content.push('2. Saya berjanji akan menjaga adab kepada para mu\'allimah MTI, Admin MTI,')
  content.push('   Musyrifah/Raisah MTI dan pasangan setoran saya.')
  content.push('')
  content.push('3. Saya berjanji tidak akan menjapri admin untuk menawar-nawar bilangan yang telah saya')
  content.push('   sanggupi.')
  content.push('')
  content.push('4. InsyaAllah saya sanggup dan akan semaksimal mungkin menyelesaikan ziyadah sesuai')
  ...
  content.push('')
  content.push('5. InsyaAllah saya sanggup mendengarkan murottal ayat yang akan dihafal minimal 3 kali.')
  content.push('')
  content.push('6. InsyaAllah saya sanggup membaca ¼ halaman sebanyak 40 kali.')
  content.push('')
  content.push('')
  content.push('7. InsyaAllah saya sanggup:')
  content.push('   a. Menghafal ¼ halaman per hari dengan merekam ayat yang telah dihafal tanpa')
  content.push('      melihat mushaf (bil-ghaib) sebanyak 3 kali berturut-turut.')
  content.push('   b. Menyimak rekaman bacaan saya ¼ halaman sebanyak 3 kali hingga selesai.')
  content.push('   c. Tidak akan mengulang rekaman jika menemukan kesalahan sebelum selesai menyimak')
  content.push('      rekaman hafalan saya (¼ halaman sebanyak 3 kali).')
  content.push('   d. Menyetor kepada pasangan hanya jika saya telah mengecek rekaman hafalan saya (¼')
  content.push('      halaman sebanyak 3 kali) dan memastikan bahwa bacaan tersebut sudah benar 100')
  content.push('      persen.')
  content.push('   e. Tidak akan menyetor kepada pasangan apabila saya masih menemukan satu kesalahan')
  content.push('      pun pada rekaman hafalan saya.')
  content.push('')
  content.push('')
  content.push('8. Saya siap menyetor lewat telepon Whatsapp 40 kali setelah saya melakukan poin nomor 7.')
  content.push('')
  content.push('9. Saya siap menyimak setoran hafalan pasangan 40 kali sambil melihat Al Quran dan siap')
  ...
  content.push('')
  content.push('10. Jika saya memiliki udzur yang menghalangi setoran telepon WhatsApp 40 kali, maka saya')
  ...
  content.push('')
  content.push('')
  content.push('11. Saya siap melakukan setoran bersama pasangan setoran pada waktu yang telah saya pilih')
  content.push('    di formulir pendaftaran, yaitu pada hari Senin-Kamis:')
  content.push('')
  ...
  content.push('')
  content.push('')
  content.push('12. Saya siap menyetor hafalan ziyadah saya pada hari sebelumnya sebanyak 5 kali kepada')
  content.push('    pasangan saya sebelum menyetor ziyadah pada hari yang ditentukan.')
  content.push('')
  content.push('13. Saya siap menyetor Rabth 1 kali 10 blok untuk mengikat ziyadah saya 10 hari sebelumnya.')
  content.push('')
  content.push('')
  content.push('14. Peralatan:')
  ...
  content.push('')
  content.push('')
  content.push('15. Saya akan berusaha semaksimal mungkin untuk disiplin laporan dan saya akan')
  content.push('    semaksimal mungkin mengingatkan pasangan saya untuk laporan.')
  content.push('')
  content.push('')
  content.push('16. Saya menyatakan siap dan tidak akan melakukan tuntutan atau korespondensi yang tidak')
  content.push('    se mestinya kepada admin apabila saya dikenakan sanksi daftar hitam (blacklist)')
  content.push('    permanen dari Program Tikrar MTI. Sanksi ini berlaku jika saya mengundurkan diri di')
  content.push('    tengah program karena tidak menyelesaikan tugas pekanan dan/atau lalai melaporkan')
  content.push('    kewajiban, kecuali jika disebabkan oleh udzur syar\'i sebagai berikut:')
  content.push('')
  content.push('    a. Qadarullah, saya sendiri/orang tua/mertua/suami/anak sakit dan membutuhkan')
  content.push('       perawatan intensif.')
  content.push('    b. Qadarullah, saya hamil muda dan mengalami gejala (seperti ngidam/muntah-muntah)')
  content.push('       yang sangat menyulitkan untuk menjalankan program. (Bagi peserta yang hamil tua')
  content.push('       diharapkan bersabar menunggu angkatan selanjutnya).')
  content.push('    c. Qadarullah, terjadi bencana alam yang tidak memungkinkan saya untuk melanjutkan')
  content.push('       program ini.')
  content.push('    d. Udzur lain yang mendesak/tiba-tiba dan di luar perkiraan yang dapat dimaklumi')
  content.push('       oleh pihak Markaz Tikrar Indonesia.')
  content.push('')
  content.push('')
  content.push('17. Saya siap untuk dikeluarkan dari program (di-DO) apabila dalam sepekan saya tidak')
  content.push('    memenuhi target karena udzur syar\'i sebagaimana tercantum pada poin 16, dengan tetap')
  content.push('    memiliki hak untuk mendaftar kembali dari awal pada angkatan selanjutnya.')
  content.push('')
  content.push('18. Apabila di tengah program saya mengundurkan diri karena larangan suami/orang tua/')
  content.push('    majikan yang sebelumnya telah memberikan izin pada saat pendaftaran, maka saya')
  content.push('    bersedia pihak yang memberikan izin tersebut langsung menghubungi Kak Mara melalui')
  content.push('    panggilan WhatsApp (menggunakan nomor yang terdaftar pada formulir pendaftaran)')
  content.push('    dan saya siap untuk di-DO permanen.')
  content.push('')
  content.push('')
  content.push('19. Saya memahami bahwa seluruh peraturan dalam akad ini tidak bertujuan mempersulit')
  content.push('    peserta program MTI dalam menghafal Al-Qur\'an. Sebaliknya, semua aturan ini')
  content.push('    semata-mata untuk menjaga hak saya dan mitra setoran agar program dapat berjalan')
  content.push('    dengan tertib dan adil demi mencapai cita-cita mulia kita bersama dalam')
  content.push('    membersamai Al-Qur\'an.')
  content.push('')
  content.push('')
