                              ...
                              <div className="space-y-3">
                                ...
                                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 sm:p-4">
                                  <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                      <h4 className="text-sm font-semibold text-yellow-800 mb-1">Menunggu Informasi Selanjutnya</h4>
                                      <p className="text-xs text-yellow-700">
                                        Fitur rekam suara sedang dalam proses persiapan. Harap tunggu informasi selanjutnya dari admin melalui grup WhatsApp.
                                      </p>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                                  {/* Card Rekam Suara - DISABLED FOR NON-ADMIN */}
                                  <Card className={`border-2 border-gray-300 bg-gray-100 opacity-60 cursor-not-allowed`}>
                                    <CardContent className="p-3 sm:p-4">
                                      <div className="flex items-center space-x-2 sm:space-x-3 mb-2">
                                        ...
                                        <div className="flex-grow">
                                          <h4 className="text-sm sm:text-base font-semibold text-gray-600">Rekam Suara</h4>
                                          <p className="text-xs text-gray-500">Ujian lisan</p>
                                        </div>
                                      </div>
                                      <p className="text-xs text-gray-600">
                                        Menunggu informasi dari admin
                                      </p>
                                    </CardContent>
                                  </Card>
                                    ...
                                    <Card className={`border-2 border-gray-300 bg-gray-100 opacity-60 cursor-not-allowed`}>
                                      <CardContent className="p-4">
                                        <div className="flex items-center space-x-3 mb-2">
                                          ...
                                          <div className="flex-grow">
                                            <h4 className="text-base font-semibold text-gray-600">Rekam Suara</h4>
                                            <p className="text-sm text-gray-500">Ujian lisan</p>
                                          </div>
                                        </div>
