...
import { submitPraTikrarRegistration } from './actions'
import { getRegistrationQuestions } from '../tikrar-tahfidz/actions'
...
export default function ThalibahBatch2Page() {
  ...
  const totalSections = 4 // Section 0 (Data Diri) + Sections 1, 2, 4(now 3)
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const result = await submitPraTikrarRegistration(
        formData,
        userProfile,
        user,
        activeBatchData,
          ...
          <Card className="shadow-lg border-green-100">
            ...
            <CardContent className="px-3 sm:px-6 pt-4 sm:pt-6">
              <form onSubmit={(e) => e.preventDefault()} className="space-y-4 sm:space-y-6">
                ...
                {currentSection === 3 && renderSection4()}
