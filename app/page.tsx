...
import { LandingTestimonialsCarousel } from '@/components/LandingTestimonialsCarousel';
import {
  Star,
  Users,
  Trophy,
        ...
        <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
          ...
          <div className="mb-2 sm:mb-4">
            <Badge className="bg-green-900 text-white border-0 px-4 sm:px-6 py-2 sm:py-3 text-sm font-semibold shadow-lg">
              ...
              Program Tahfidz Premium Gratis
            </Badge>
          </div>
      ...
      {testimonials && testimonials.length > 0 && (
        <section className="py-24 bg-gradient-to-b from-white to-[#F4F7F5]">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <LandingTestimonialsCarousel testimonials={testimonials} />
          </div>
        </section>
      )}
