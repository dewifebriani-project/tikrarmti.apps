-- ==========================================
-- Database Updates for Selection System
-- ==========================================
...
CREATE POLICY IF NOT EXISTS "Allow anonymous users to read selection audios"
ON storage.objects FOR SELECT
USING (bucket_id = 'selection-audios');

-- Allow authenticated upload
CREATE POLICY IF NOT EXISTS "Allow users to upload selection audios"
...
CREATE POLICY IF NOT EXISTS "Allow users to update own selection audios"
...
CREATE POLICY IF NOT EXISTS "Allow authenticated users to read selection audios"
ON storage.objects FOR SELECT
...
COMMENT ON storage.buckets.selection-audios IS 'Storage bucket for oral selection audio recordings';
