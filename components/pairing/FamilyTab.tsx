...
import { Clock, CheckCircle, RotateCcw, HeartHandshake, Home } from 'lucide-react'
              ...
              {requests.map((request) => (
                <tr key={request.id} className={`hover:bg-gray-50 ${request.is_paired ? 'bg-green-50' : ''}`}>
                  ...
                  <td className="px-2 py-2 whitespace-nowrap text-sm text-center">
                    <span className="font-semibold text-gray-700">{request.exam_score !== undefined && request.exam_score !== null ? request.exam_score : '-'}</span>
                  </td>
