...
# 9. HalaqahSelectionStep rewrite
...
action_start = "                {/* Action Buttons */}"
action_end = "                </div>\n              </div>"
text = replace_between(text, action_start, action_end, "", True, False)


# Modify logic
logic_start = "  const toggleUjian = (halaqahId: string) => {"
logic_end = "  const isTashihSelected = (halaqahId: string) => formData.tashih_halaqah_id === halaqahId"

new_logic = """  const togglePackage = (halaqahId: string) => {
...
"""
text = replace_between(text, logic_start, logic_end, new_logic, True, True)

# Modify mapping
map_start = "          sortedHalaqahData.map(halaqah => {"
map_end = "                {/* Header with name and class type badge */}"
...
text = replace_between(text, map_start, map_end, new_map, True, False)
