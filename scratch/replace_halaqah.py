...
# Modify HalaqahSelectionStep content
...
start_marker2 = "            const ujianSelected = isUjianSelected(halaqah.id)"
end_marker2 = "                <div className=\"flex flex-col md:flex-row gap-4 mb-4\">"
old_block2 = extract_block(content, start_marker2, end_marker2)

new_block2 = """            const selected = isSelected(halaqah.id)
