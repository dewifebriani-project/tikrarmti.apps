...
async function runVerification() {
  console.log('--- START VERIFICATION: MUALLIMAH REGISTRATION FORM BUILDER SYSTEM ---');

  // 1. Fetch all questions (representing getMuallimahRegistrationQuestionsAdmin)
  ...
  console.log(`Successfully fetched ${allQuestions.length} questions from muallimah_registration_questions.`);
  
  // Find a specific question to test: 'tajweed_institution'
  const testKey = 'tajweed_institution';
  ...
  const newLabel = 'Lembaga Belajar Tajwid (MTI, LTQ, dll)';
  ...
  // 3. Verify public query (representing getMuallimahRegistrationQuestions)
