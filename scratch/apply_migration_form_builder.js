...
async function run() {
  const email = 'temp-form-migration-admin@markaztikrar.id';
  ...
  try {
    ...
    const sql = fs.readFileSync(path.join(process.cwd(), 'supabase/migrations/20260620_create_registration_questions.sql'), 'utf8');
