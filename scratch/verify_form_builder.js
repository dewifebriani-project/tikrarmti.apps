...
async function runVerification() {
  console.log('--- START VERIFICATION: FORM BUILDER SYSTEM ---');

  // 1. Fetch all questions (representing getRegistrationQuestionsAdmin)
  ...
  console.log(`Successfully fetched ${allQuestions.length} questions from registration_questions.`);
  
  // Find a specific question to test: 'understands_commitment'
  const testKey = 'understands_commitment';
  ...
  const newLabel = 'Bismillah, apakah Ukhti bersedia berkomitmen 100% untuk program ini?';
  ...
  // 3. Verify public query (representing getRegistrationQuestions)
