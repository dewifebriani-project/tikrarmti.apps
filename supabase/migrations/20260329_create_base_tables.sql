-- ============================================================================
-- CREATE BASE TABLES FOR TIKRARMTI APPS
-- ============================================================================
-- This migration creates all base tables in the correct order with proper
-- foreign key relationships.
--
-- Order: users -> batches -> programs -> halaqah -> others
--
...
CREATE TABLE IF NOT EXISTS public.exam_attempts (
  ...
  status text DEFAULT 'in_progress'::text NOT NULL CHECK (status = ANY (ARRAY['in_progress'::text, 'submitted'::text, 'graded'::text])),
  ...
  CONSTRAINT exam_attempts_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE,
  CONSTRAINT exam_attempts_registration_fkey FOREIGN KEY (registration_id) REFERENCES public.pendaftaran_tikrar_tahfidz(id) ON DELETE CASCADE
);
...
-- ============================================================================
-- DAFTAR_ULANG_SUBMISSIONS TABLE
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS public.daftar_ulang_submissions (
  ...
  CONSTRAINT daftar_ulang_submissions_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE,
  CONSTRAINT daftar_ulang_submissions_registration_id_fkey FOREIGN KEY (registration_id) REFERENCES public.pendaftaran_tikrar_tahfidz(id) ON DELETE CASCADE,
  CONSTRAINT daftar_ulang_submissions_batch_id_fkey FOREIGN KEY (batch_id) REFERENCES public.batches(id) ON DELETE CASCADE,
  CONSTRAINT daftar_ulang_submissions_partner_user_id_fkey FOREIGN KEY (partner_user_id) REFERENCES public.users(id) ON DELETE SET NULL,
  CONSTRAINT daftar_ulang_submissions_ujian_halaqah_id_fkey FOREIGN KEY (ujian_halaqah_id) REFERENCES public.halaqah(id) ON DELETE SET NULL,
  CONSTRAINT daftar_ulang_submissions_tashih_halaqah_id_fkey FOREIGN KEY (tashih_halaqah_id) REFERENCES public.halaqah(id) ON DELETE SET NULL,
  CONSTRAINT daftar_ulang_submissions_reviewed_by_fkey FOREIGN KEY (reviewed_by) REFERENCES public.users(id) ON DELETE SET NULL
);

-- Create indexes for daftar_ulang_submissions
...
COMMENT ON TABLE public.daftar_ulang_submissions IS 'Submitan daftar ulang thalibah';
